package com.baccredomatic.storeandforwardservices.controllers;
...
import com.baccredomatic.storeandforwardservices.services.MessageService;
...
/*****/	
	...
	public ResponseEntity<String> postMessage(
		...
		try{			
			String response = messageService.sendWithReply(message.getContent(), xmlVersion);

package com.baccredomatic.storeandforwardservices.services;
...
public class MessageService {
    ...
    public String sendWithReply(String message, String xmlVersion) throws JMSException, NamingException {
    	...
    	try {
	        ...
	        textMessage.setStringProperty(PROPERTY_PAGUELO_MESSAGE_XML_VERSION, xmlVersion);
